        ...
        <div className="container mx-auto max-w-7xl px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              ...
              <Button asChild><Link href="/booking">Trial Pure IX Today</Link></Button>
            </div>
        ...
        <div className="container mx-auto max-w-7xl px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-sm italic text-muted-foreground">The perfect solution for those who prefer traditional batteries in a slim, elegant housing.</p>
            </div>
          </div>
        </div>
      </section>
